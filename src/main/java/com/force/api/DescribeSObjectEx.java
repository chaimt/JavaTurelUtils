...
/**
 * Created by Chaim on 06/06/2017.
 */
@JsonIgnoreProperties(ignoreUnknown=true)
public class DescribeSObjectEx extends DescribeSObjectBasic {
    ...
    public Map<String, String> getChildEntities() {
        ...
        for(DescribeSObjectEx.ChildEntity child : childRelationships) {
            //skip parents
    ...
    public Set<Field> getRequiredFieldsForCreateUpdate() {
        ...
        for (DescribeSObjectEx.Field field : fields) {
    ...
    public Set<Field> getParentEntitiesForCreateUpdate() {
        Set<Field> parentReference = new HashSet<>();
        for (DescribeSObjectEx.Field field : fields) {
            if (field.isCreateable() && (field.isNillable() || field.isDefaultedOnCreate())) {
                if(field.getRelationshipName() != null) {
    ...
    public static class Field {
        ...
        private List<DescribeSObject.PicklistEntry> picklistValues;
        ...
        public List<DescribeSObject.PicklistEntry> getPicklistValues() {
